...
(function(global, factory) { /* global define, require, module */
    ...
    $root.votings_service = (function() {
        ...
        votings_service.Ballot = (function() {
             ...
             * @property {number|null} [decrypted_choice] Ballot decrypted_choice
            ...
            /**
             * Ballot decrypted_choice.
             * @member {number} decrypted_choice
             * @memberof votings_service.Ballot
             * @instance
             */
            Ballot.prototype.decrypted_choice = 0;
            ...
            Ballot.encode = function encode(message, writer) {
                ...
                if (message.decrypted_choice != null && message.hasOwnProperty("decrypted_choice"))
                    writer.uint32(/* id 5, wireType 0 =*/40).uint32(message.decrypted_choice);
            ...
            Ballot.decode = function decode(reader, length) {
                ...
                while (reader.pos < end) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        message.decrypted_choice = reader.uint32();
                        break;
                    case 6:
            ...
            Ballot.verify = function verify(message) {
                ...
                if (message.decrypted_choice != null && message.hasOwnProperty("decrypted_choice"))
                    if (!$util.isInteger(message.decrypted_choice))
                        return "decrypted_choice: integer expected";
                if (message.store_tx_hash != null && message.hasOwnProperty("store_tx_hash")) {
            ...
            Ballot.fromObject = function fromObject(object) {
                ...
                if (object.decrypted_choice != null)
                    message.decrypted_choice = object.decrypted_choice >>> 0;
            ...
            Ballot.toObject = function toObject(message, options) {
                ...
                if (message.decrypted_choice != null && message.hasOwnProperty("decrypted_choice"))
                    object.decrypted_choice = message.decrypted_choice;
                if (message.store_tx_hash != null && message.hasOwnProperty("store_tx_hash"))
