<script id="vote_start_confirm" type="text/html">
    <p>
        При нажатии на кнопку "Получить бюллетень" Вы будете перенаправлены на страницу электронного бюллетеня для голосования.
        У Вас будет 15 минут для того, чтобы осуществить свой выбор. Обращаем внимание, что переход на страницу бюллетеня возможен только один раз.
        Не пытайтесь обновить или закрыть страницу электронного бюллетеня. Сделайте свой выбор и нажмите кнопку "Проголосовать".
    </p>
