...
$router->get('/test/amqp', function () {
    $request = new \App\Service\Task\TaskVoteRequest(['PGU_USER_ID' => 0], 'dasdsadsadasd',['voitingId'=>1]);
...
$router->get('/test', function () {
    $result = array_map(function ($item) {
        return (array)$item;
    }, App\Service\Database::select('SELECT * FROM p_settings'));
