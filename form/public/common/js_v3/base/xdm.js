/**
 * Created by vpetukhov on 15.10.14.
 */
// always trusted origins, can be exact strings or regular expressions
window.alwaysTrustedOrigins = [/.*\.srvdev\.ru/,/.*\.mos\.ru/];
...
var remote = new easyXDM.Rpc({
    ...
    local: {
        ...
        request: function(config, success, error) {
            ...
            var alwaysTrusted = false, alwaysTrustedOrigins = window.alwaysTrustedOrigins, i = alwaysTrustedOrigins.length;
