...
class MgikMgd_golosovanie extends FormMgik
{
    ...
    protected $form_name = 'Дистанционное электронное голосование на выборах депутатов Московской городской Думы седьмого созыва';
    protected $service_target_title = 'Дистанционное электронное голосование на выборах депутатов Московской городской Думы седьмого созыва';
